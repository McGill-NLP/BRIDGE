#!/usr/bin/env python3
"""
Compute baseline difficulty and ability estimates using simple averaging.

This serves as a comparison to the IRT model estimates.
- Task difficulty (row-wise): 1 - success_rate (harder = higher value)
- Model ability (col-wise): success_rate (better = higher value)

Also computes logit-transformed versions for better comparability with IRT scale.
"""
...
def main():
    ...
    if args.output_dir:
        ...
        output_dir = Path(__file__).resolve().parent / "params"
